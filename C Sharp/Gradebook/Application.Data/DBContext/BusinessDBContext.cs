...
namespace AppCore.Data
{
    ...
    public class BusinessDBContext : IdentityDbContext<IdentityUser>
    {
        ...
        //private void SeedLocationType(ModelBuilder modelBuilder)
        //{
            
        //    var locationType = modelBuilder.Entity<LocationType>();
        //    locationType.Property(x => x.LocationTypeId).ValueGeneratedNever();
        //    locationType.HasData
        //        (
        //            new LocationType { LocationTypeId = (int)LocationTypeId.FoodTruck, Description = "Food Truck" },
        //            new LocationType { LocationTypeId = (int)LocationTypeId.Kiosk, Description = "Kiosk" },
        //            new LocationType { LocationTypeId = (int)LocationTypeId.Popup, Description = "Popup" },
        //            new LocationType { LocationTypeId = (int)LocationTypeId.Storefront, Description = "Store" }
        //        );
        //}
        ...
        private void AddShadowProperties(ModelBuilder modelBuilder)
        {
            foreach (var entityType in modelBuilder.Model.GetEntityTypes())
            {
                ...
                if (entityType.Name != "AppCore.Entities.Camp"
                    ...
                    && entityType.Name != "AppCore.Entities.Reach"
