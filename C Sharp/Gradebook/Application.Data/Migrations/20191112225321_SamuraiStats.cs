...
namespace AppCore.Data.Migrations
{
    public partial class SamuraiStats : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    (@"CREATE OR ALTER VIEW SamuraiBattleStats
            //        AS
            //        Select sb.SamuraiId, s.Name, COUNT(sb.BattleId) AS NumberOfBattles, EarliestBattleFoughtBySamurai(MIN(s.Id)) AS EarliestBattle
